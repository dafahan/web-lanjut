                                                ...
                                                <tbody>                                              
                                                    <tr>
                                                      ...
                                                      @if(isset($data))
                                                        ...
                                                        @endforeach
                                                        @if($id == -1)
                                                          <td><a href="createlayanan"><button class="btn btn-success">TAMBAH</button></a></td>
                                                        @else
                                                          <td>
                                                            <!-- <a href="detaillayanan/{{$data->id}}"><button class="btn btn-info">DETAIL</button></a> -->
                                                          <a href="editlayanan/{{$data->id}}"><button class="btn btn-info">DETAIL</button></a></td>
                                                        @endif
                                                      @else
                                                        <td><a href=""><button class="btn btn-success">TAMBAH</button></a></td>
                                                      @endif
                                                      
                                                    </tr>
                                                    <tr>
                                                      <td>2</td>
                                                      <td>Dokumen Layanan</td>
                                                      @if(isset($docs))
                                                        @if($id == -1)
                                                          <td><a href="createdokumenlayanan"><button class="btn btn-success">TAMBAH</button></a></td>
                                                        @else
                                                          <td>
                                                            <!-- <a href="detaillayanan/{{$data->id}}"><button class="btn btn-info">DETAIL</button></a> -->
                                                          <a href="editdokumenlayanan/{{$data->id}}"><button class="btn btn-info">DETAIL</button></a></td>
                                                        @endif
                                                      @else
                                                        <td><a href="createdokumenlayanan"><button class="btn btn-success">TAMBAH</button></a></td>
                                                      @endif
