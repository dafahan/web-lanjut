  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <form action="{{url('updatelayanan/'. $data->id)}}" method="POST">
          @method('PUT')
          @csrf
        <!--  Row 1 -->
        <div class="row">
        ...
        <div class="card" style="min-height: 485px">
                                        ...
                                        <div class="card-content table-responsive">
                                          ...
                                          <input id="deskripsi" type="hidden" name="deskripsi" value="{{$data->description}}">
                                          <trix-editor input="deskripsi"></trix-editor>
                                        </div>
                                        <button type="submit" class="btn btn-outline-info mx-3 mt-2 d-block ml-auto" style="max-width: 10%;" >Kembali</button>
