                                                ...
                                                <tbody>                                              
                                                    <tr>
                                                      ...
                                                      @if(isset($data))
                                                        ...
                                                        @endforeach
                                                        @if($id == -1)
                                                          <td><a href="createmisi"><button class="btn btn-success">TAMBAH</button></a></td>
                                                        @else
                                                          <td><a href="detailmisi/{{$data->id}}"><button class="btn btn-info">DETAIL</button></a>
                                                          <a href="editmisi/{{$data->id}}"><button class="btn btn-warning">EDIT</button></a></td>
                                                        @endif
                                                      @else
