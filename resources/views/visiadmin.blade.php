                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                      ...
                                                      @if(isset($data))
                                                        ...
                                                        @endforeach
                                                        @if($id == -1)
                                                          <td><a href="createvisi"><button class="btn btn-success">TAMBAH</button></a></td>
                                                        @else
                                                          <td><a href="detailvisi/{{$data->id}}"><button class="btn btn-info">DETAIL</button></a>
                                                          <a href="editvisi/{{$data->id}}"><button class="btn btn-warning">EDIT</button></a></td>
                                                        @endif
                                                      @else
