...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <form action="{{url('updatestruktur/'. $data->id)}}" method="POST" enctype="multipart/form-data">
          @method('put')
          @csrf
        <!--  Row 1 -->
        <div class="row">
        ...
        <div class="card" style="min-height: 485px">
                                        ...
                                        <div class="mb-3">
                                          <div class="prev-img mb-3 ml-4" style="margin-left: 20px;">
                                          @if (!empty($data->image))
                                              <img src="{{asset('storage/' . $data->image)}}" alt="Gambar Sebelumnya" style="max-width: 100px;">
                                          @endif
                                          </div>
                                          <input class="form-control" type="file" id="gambar" name="gambar" style="max-width: 80%; margin-left:15px;">
                                        </div>
                                        <div>
  ...
  <script src="{{asset('/')}}js/dashboard.js">document.addEventListener('trix-file-accept-', function(e){
      e.preventDefault();
    })</script>
</body>
