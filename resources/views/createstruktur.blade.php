  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <form action="{{('storestruktur')}}" method="POST" enctype="multipart/form-data">
          @csrf
        <!--  Row 1 -->
        <div class="row">
        ...
        <div class="card" style="min-height: 485px">
                                        <div class="card-header card-header-text">
                                            <h4 class="card-title">Create Struktur</h4>
                                        </div>
                                        <div class="mb-3">
                                          <label for="gambar" class="form-label" style="max-width: 80%; margin-left:15px;">Upload Gambar</label>
