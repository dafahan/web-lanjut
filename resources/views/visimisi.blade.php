...
<body>
	...
	<div class="hero overlay inner-page">
		...
		<!-- <div class="media">
			...
			<iframe width="560" height="315" src="https://www.youtube.com/embed/TYpbghkAYAU?si=M4L_-1wFoNE52MXr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
			</div>
		</div> -->
			<div class="row align-items-center justify-content-center text-center pt-5">
				<div class="col-lg-6">
					<h1 class="heading text-white mb-3" data-aos="fade-up">Visi & Misi</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- <div class="section sec-cta">
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div div class="col-lg-5" data-aos="fade-up" data-aos-delay="0">
					<div class="media">
					<iframe width="100%" height="100%" src="https://www.youtube.com/embed/TYpbghkAYAU?si=M4L_-1wFoNE52MXr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5" data-aos="fade-up" data-aos-delay="0">
                <div class="visi">
                    <header class="heading text-black ml-2">Visi</header><br>
					@if(isset($visi))
					{!!$visi->description!!}
					@endif
                </div>
                <hr class="divider">
                <div class="misi mt-3">
                    <header class="heading text-black ml-2 mt-3">Misi</header><br>
                    @if(isset($misi))
					{!!$misi->description!!}
					@endif
                </div>
