      ...
      <div class="container-fluid">
        ...
        <div class="card" style="min-height: 485px">
                                        <div class="card-header card-header-text">
                                            <h4 class="card-title">Create Dokumen Layanan</h4>
                                        </div>
                                        <div class="card-content table-responsive">
                                          ...
                                          <div class="mb-3">
                                          <label for="dokumen" class="form-label" style="max-width: 80%; margin-left:15px;">Upload Dokumen</label>
                                          <input class="form-control" type="file" id="document" name="document" style="max-width: 80%; margin-left:15px;">
                                        </div>
                                            <!-- <div class="form-group" style="max-width: 90%; margin-left:30px;">
